    ...
    <div class="wrapper">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <table class="tbl-30">
                <tr>
                    <td>Title:</td>
                    <td>
                        <input type="text" name="title" placeholdder="category Title">
                    </td>
                </tr>
        ...
        <?php 
            ...
            if(isset($_POST['submit']))
            {
                ...
                //2.for radio input type check whether the button is selected or not
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    //rename the image
                    $image_name = "food_category_".rand(000, 999).'.'.$ext; //eg food_category_789.jpg
                    ...
                    //check whethere the image is uploaded or not
                ...
                //4. check the query is executed or not and data added or not
                if($res==true)
                {
